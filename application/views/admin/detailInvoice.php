...
<div class="card-header text-center"><b>Detail Pemesanan</b></div>
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        <form action="" method="post">      
            ...
            <?php 
                if($status == 1){
                    echo '
                    <button class="btn btn-primary mt-2" type="submit">Konfirmasi Pemesanan</button>
                    ';
                }
                else if($status == 2){
                    echo '
                    <div class="btn btn-primary disabled">Status Pemesanan</div> : Sending
                    ';
                }
                else if($status == 3){
                    echo '
                    <div class="btn btn-primary disabled">Status Pemesanan</div> :  Success 
                    ';
                }
            ?>
        </form>
